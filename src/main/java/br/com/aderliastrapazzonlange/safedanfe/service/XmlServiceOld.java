...
import br.com.aderliastrapazzonlange.safedanfe.models.FileXmlOld;
...
@Service
public class XmlServiceOld {

	private final FileManagerOld file;
	private final FileXmlOld xml;
	...
	@Autowired
	public XmlServiceOld(FileManagerOld file, FileXmlOld xml, ProviderRepository providerRepository,
